...
reg add "HKCU\Software\Classes\NoteBook.Text" /ve /d "Metin notu" /f >nul
reg add "HKCU\Software\Classes\NoteBook.Text" /v "FriendlyTypeName" /d "Metin notu" /f >nul
reg add "HKCU\Software\Classes\NoteBook.Text\DefaultIcon" /ve /d "\"%EXE%\",0" /f >nul
reg add "HKCU\Software\Classes\NoteBook.Text\shell\open" /ve /d "Notlar ile ac" /f >nul
reg add "HKCU\Software\Classes\NoteBook.Text\shell\open\command" /ve /d "\"%EXE%\" \"%%1\"" /f >nul
...
reg add "HKCU\Software\Classes\.txt\OpenWithProgids" /v "NoteBook.Text" /t REG_NONE /f >nul
